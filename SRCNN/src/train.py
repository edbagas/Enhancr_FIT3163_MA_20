...
file = h5py.File('C:\\Users\\ASUS\\OneDrive - Monash University\\Documents\\SCHOOL\\FYP\\input\\train_mscale.h5', 'r+')
...
def validate(model, dataloader, epoch):
    ...
    with torch.no_grad():
        for bi, data in tqdm(enumerate(dataloader), total=int(len(val_data)/dataloader.batch_size)):
            ...
            running_psnr += batch_psnr
        outputs = outputs.cpu()
        save_image(outputs, f"C:\\Users\\ASUS\\OneDrive - Monash University\\Documents\\SCHOOL\\FYP\\outputs\\val_sr{epoch}.png")
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('C:\\Users\\ASUS\\OneDrive - Monash University\\Documents\\SCHOOL\\FYP\\outputs\\loss.png')
plt.show()
# psnr plots
plt.figure(figsize=(10, 7))
...
plt.ylabel('PSNR (dB)')
plt.legend()
plt.savefig('C:\\Users\\ASUS\\OneDrive - Monash University\\Documents\\SCHOOL\\FYP\\outputs\\psnr.png')
plt.show()
# save the model to disk
print('Saving model...')
torch.save(model.state_dict(), 'C:\\Users\\ASUS\\OneDrive - Monash University\\Documents\\SCHOOL\\FYP\\outputs\\model.pth')